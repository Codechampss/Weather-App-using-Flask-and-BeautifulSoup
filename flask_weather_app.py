    	...
    	if request.method == 'POST':
    		...
    		if link5=="N/A":
    			...
    			for i in soup.find_all("div" ,{"class":"col-md-12 section-three"}):
    				...
    				print(quantity4)
    				return render_template("flask_weather_app.html",price=price,url1=url1,title=title,quantity=quantity,stock=stock,link2=link2,title1=title1,a=a,url3=url=3,title3=title3,price3=price3,quantity3=quantity3,p=p,link=link,quantity4=quantity4,price4=price4,stock3=stock3,link5=link5)
